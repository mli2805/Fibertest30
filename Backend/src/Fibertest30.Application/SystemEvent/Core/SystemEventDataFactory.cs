...
public static class SystemEventDataFactory
{
    public static ISystemEventData? Create(SystemEventType type, string jsonData)
    {
        return type switch
        {
            ...
            SystemEventType.MonitoringPortAlarmProfileChanged => Deserialize<MonitoringPortAlarmProfileChangedData>(jsonData),
            ...
            SystemEventType.AlarmProfileChanged => Deserialize<AlarmProfileChangedData>(jsonData),
            SystemEventType.AlarmProfileCreated => Deserialize<AlarmProfileCreatedData>(jsonData),
            SystemEventType.AlarmProfileDeleted => Deserialize<AlarmProfileDeletedData>(jsonData),
