...
namespace Fibertest30.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20240613123522_AddMonitoringPortNote")]
    partial class AddMonitoringPortNote
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Fibertest30.Application.AlarmGroupIdEf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("AlarmGroupId", (string)null);
                });
            ...
            modelBuilder.Entity("Fibertest30.Application.MonitoringAlarmEventEf", b =>
                {
                    ...
                    b.Property<int>("MonitoringAlarmGroupId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Fibertest30.Application.MonitoringResult", b =>
                {
                    ...
                    b.Property<int?>("MostSevereChangeLevel")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("CompletedAt", "MonitoringPortId");
            ...
            modelBuilder.Entity("Fibertest30.Infrastructure.PortLabelEf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("PortLabel", (string)null);
                });

            modelBuilder.Entity("Fibertest30.Infrastructure.PortLabelMonitoringPortEf", b =>
                {
                    b.Property<int>("PortLabelId")
                        .HasColumnType("INTEGER");

                    b.Property<int>("MonitoringPortId")
                        .HasColumnType("INTEGER");

                    b.HasKey("PortLabelId", "MonitoringPortId");

                    b.HasIndex("MonitoringPortId");

                    b.ToTable("PortLabelMonitoringPort", (string)null);
                });
            ...
            modelBuilder.Entity("Fibertest30.Infrastructure.PortLabelMonitoringPortEf", b =>
                {
                    b.HasOne("Fibertest30.Application.MonitoringPortEf", "MonitoringPort")
                        .WithMany("PortLabelMonitoringPorts")
                        .HasForeignKey("MonitoringPortId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Fibertest30.Infrastructure.PortLabelEf", "PortLabel")
                        .WithMany("PortLabelMonitoringPorts")
                        .HasForeignKey("PortLabelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MonitoringPort");

                    b.Navigation("PortLabel");
                });
            ...
            modelBuilder.Entity("Fibertest30.Application.MonitoringPortEf", b =>
                {
                    ...
                    b.Navigation("PortLabelMonitoringPorts");
