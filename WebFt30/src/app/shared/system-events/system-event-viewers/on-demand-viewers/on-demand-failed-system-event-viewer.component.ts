...
import { OnDemandFailedData } from '../../system-event-data';
...
@Component({
  template: `
    <div class="text-red-500 dark:text-red-400">
      {{ 'i18n.system-events-viewer.on-demand-failed' | translate }}
    </div>
...
export class OnDemandFailedSystemEventViewerComponent {
  data!: OnDemandFailedData;
  failReason!: string | null;

  @Input() set systemEvent(value: SystemEvent) {
    this.data = <OnDemandFailedData>JSON.parse(value.jsonData);
