...
@NgModule({
  imports: [OpEvntsRoutingModule, SharedModule, FiberizerCoreModule],
  exports: [],
  declarations: [OpEvntsComponent, OpticalEventsComponent, OpticalEventViewComponent, TraceInfoComponent],
  providers: []
})
