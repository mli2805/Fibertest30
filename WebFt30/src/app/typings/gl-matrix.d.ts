...
// Definitions by: s.matushonok, based on https://github.com/chuntaro/gl-matrix.d.ts and https://github.com/DefinitelyTyped/DefinitelyTyped
...
declare module 'gl-matrix' {
  ...
  export class glMatrix {
    ...
    public static ARRAY_TYPE: Float32Array | Array<number>;
     ...
     */
    public static setMatrixArrayType<T>(type: T): void;
  ...
  export class vec2 extends Float32Array {
     ...
     * @returns {vec2} out
     */
    public static set(out: vec2, x: number, y: number): vec2; // not Float32Array compatible
     ...
     */
    public static length(a: vec2): number; // not Float32Array compatible
    ...
    public static forEach<T>(
      ...
      arg: T
    ): vec2[]; // not Float32Array compatible
  ...
  export class vec3 extends Float32Array {
     ...
     * @returns {vec3} out
     */
    public static set(out: vec3, x: number, y: number, z: number): vec3; // not Float32Array compatible
     ...
     * @returns {Number} length of a
     */
    public static length(a: vec3): number; // not Float32Array compatible
     ...
     * @returns {vec3} out
     */
    public static transformMat3(out: vec3, a: vec3, m: mat4): vec3;
    ...
    public static forEach<T>(
      ...
      arg: T
    ): vec3[]; // not Float32Array compatible
  ...
  export class vec4 extends Float32Array {
     ...
     * @returns {vec4} out
     */
    public static set(out: vec4, x: number, y: number, z: number, w: number): vec4; // not Float32Array compatible
     ...
     * @returns {Number} length of a
     */
    public static length(a: vec4): number; // not Float32Array compatible
    ...
    public static forEach<T>(
      ...
      arg: T
    ): vec4[]; // not Float32Array compatible
  ...
  export class mat2 extends Float32Array {
     ...
     * @returns {mat2} out
     */
    public static set(out: mat2, m00: number, m01: number, m10: number, m11: number): mat2; // not Float32Array compatible
  ...
  export class mat2d extends Float32Array {
    ...
    public static set(
      ...
      tx: number,
      ty: number
    ): mat2d; // not Float32Array compatible
  ...
  export class mat3 extends Float32Array {
    ...
    public static set(
      ...
      m21: number,
      m22: number
    ): mat3; // not Float32Array compatible
     ...
     * @returns {mat3} out
     */
    public static romTranslation(out: mat3, v: vec2): mat3;
     ...
     * @returns {String} string representation of the matrix
     */
    public static str(a: mat3): string;
  ...
  export class mat4 extends Float32Array {
    ...
    public static set(
      ...
      m32: number,
      m33: number
    ): mat4; // not Float32Array compatible
  ...
  export class quat extends Float32Array {
     ...
     * @returns {quat} out
     */
    public static setAxes(out: vec3, view: vec3, right: vec3, up: quat): quat;
     ...
     * @function
     */
    public static set(out: quat, x: number, y: number, z: number, w: number): quat; // not Float32Array compatible
     ...
     * @function
     */
    public static length(a: quat): number; // not Float32Array compatible
